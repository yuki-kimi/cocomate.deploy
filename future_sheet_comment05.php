...
<h2 class="section-title">５．理想のパートナーシップ像について</h2>
...
// あなたのコメントを取得
$query = "SELECT family_comment_05 FROM profile_familyvalue_table WHERE user_id = ?";
...
<div class="advice-box">
    <div class="advice-text-container">
        ...
        <p>恋人でも家族でもない“パートナー”ってどんな存在なのか、言葉のニュアンスをふくらませながら話してみると楽しいです。</p>
        <p>「それって友達とどう違うと思う？」など、関係性のイメージを探ることで、理想の距離や関わり方が見えてきます。</p>
        </div>
    </div>
...
<div class="button-section">
    ...
    <button class="nav-button" onclick="window.location.href='future_sheet_comment04.php?user_id=<?php echo htmlspecialchars($other_user_id, ENT_QUOTES, 'UTF-8'); ?>'">前にもどる</button>    
    <!-- 次にすすむボタン -->
    <button class="nav-button" onclick="window.location.href='future_sheet_comment06.php?user_id=<?php echo htmlspecialchars($other_user_id, ENT_QUOTES, 'UTF-8'); ?>'">次にすすむ</button>
</div>
</body>
</html>